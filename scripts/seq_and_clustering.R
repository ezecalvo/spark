...
data_scaling <- function(metric_df){
  ...
  data_to_scale <-  metric_df[,c("transcript_id","gene_length" ,"transcript_length","number_of_exons","number_of_introns","mean_exon_length","mean_intron_length","first_exon_length","first_intron_length","five_prime_utr","three_prime_utr","transcript_A","transcript_C","transcript_T","transcript_G","exon_A","exon_C","exon_T","exon_G","intron_A","intron_C","intron_T","intron_G")]
...
#############
#GTF for making reads generation
